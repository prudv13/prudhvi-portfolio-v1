...
import DeveloperResume from "../../assets/developer_resume.pdf";
import DesignerResume from "../../assets/designer_resume.pdf";
    ...
    <section className='about section' id='about'>
        ...
        <div className='about__container container grid'>
            ...
            <div className='about__data'>
                ...
                <a download='' href={DesignerResume} className='button button__flex'>
                    Designer Resume
                    <svg
                        class="button__icon"
                        xmlns="http://www.w3.org/2000/svg"
